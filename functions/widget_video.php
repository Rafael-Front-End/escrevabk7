<?php
add_action("widgets_init",function(){register_widget("New_Widget_Media_Video"); });
class New_Widget_Media_Video extends WP_Widget_Media {
    ...
    parent::__construct( 'text', 'Zflag Video', $widget_ops, $control_ops );
